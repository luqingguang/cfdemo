require({cache:{
'gridx/mobile/tests/test_pull_refresh':function(){
define([
	'dojo/_base/declare',
	'dojo/domReady',
	'dojo/store/JsonRest',
	...
	"dojox/mobile/compat",
	'dojox/mobile/TabBar'
], function(declare, ready, JsonRest, parser, data, Grid, PullRefresh){
	var columns = [
...
'gridx/mobile/tests/support/data':function(){
define(function(){
...
'gridx/mobile/nls/common':function(){
define({root:
({
...
'gridx/mobile/PullRefresh':function(){
define([
	'dojo/_base/declare',
	'dojo/_base/lang',
	'dojo/_base/array',
...
'gridx/mobile/nls/PullRefresh':function(){
define({root:
({
...
'gridx/mobile/LazyLoad':function(){
define([
	'dojo/_base/declare',
	'dojo/_base/lang',
	'dojo/_base/array',
...
'gridx/mobile/nls/LazyLoad':function(){
define({root:
({
	loading: 'Loading...'
	,loadMore: 'Load More'
...
define([
	...
	return declare("dojox.mobile.TransitionEvent", null, {
		...
		dispatch: function(){
			...
			//0 && console.log("Target: ", this.target, " opts: ", opts);
