...
define([ "dojo/_base/declare", 
         ...
         "dojo/text!./resources/TopicSmallTemplate.html",
], 
function(declare, parser, _WidgetBase, _TemplatedMixin,_WidgetsInTemplateMixin, template) {
return declare("bluemix.TopicSmallTemplate", 
	...
	onFollowActionClick: function(id){
		if(this.followAction.innerHTML == "UnFollow"){
			this.followAction.innerHTML = "Follow";
			/*dojo.xhrPost({
			...
			this.followAction.innerHTML = "UnFollow";
			/*dojo.xhrPost({
				url:"/topic/follow/" + id,
				headers: {"Content-Type": "application/json", "Accept": "application/json"},
				postData: dojo.toJson({
